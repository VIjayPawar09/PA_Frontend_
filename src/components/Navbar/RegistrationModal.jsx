...
export const RegistrationModal = ({ isOpen, onClose, userType }) => {
    ...
    const handleSubmit = async (e) => {
      ...
      alert(`Registration successful! You've registered as ${userType === "assistant" ? "an assistant" : "a customer"}.`);
        ...
        >
          ...
          <div className="p-6 border-b">
            <h2 className="text-2xl font-bold text-gray-800">
              {userType === "assistant" ? "Register as Assistant" : "Register as Customer"}
            </h2>
            ...
            <div className="flex mt-4 text-sm">
              <div className={`flex-1 text-center py-2 rounded-l-lg ${step === 1 ? "bg-purple-100 text-purple-700 font-medium" : "text-gray-500"}`}>
                Account Info
              </div>
              <div className={`flex-1 text-center py-2 rounded-r-lg ${step === 2 ? "bg-purple-100 text-purple-700 font-medium" : "text-gray-500"}`}>
                {userType === "assistant" ? "Professional Details" : "Personal Details"}
              </div>
            </div>
          </div>
            ...
            <form onSubmit={step === 2 ? handleSubmit : e => { e.preventDefault(); handleNextStep(); }}>
                ...
                <>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-2">
                      {["Personal Care", "Medical Assistance", "Mobility Assistance", "Companionship", "Household Help", "Dementia Care"].map((spec) => (
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-2">
                      {["Weekday Mornings", "Weekday Afternoons", "Weekday Evenings", "Weekend Mornings", "Weekend Afternoons", "Weekend Evenings", "Overnight Care"].map((time) => (
                        <div key={time} className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor={`avail-${time}`} className="ml-2 block text-sm text-gray-700">
                            {time}
                          </label>
                        </div>
                      ))}
                  ...
                  {/* Certifications */}
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-medium mb-1" htmlFor="certifications">
              ...
              {step === 2 && userType === "customer" && (
                <>
                  ...
                  {/* Emergency Contact */}
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-medium mb-1" htmlFor="emergencyContact">
                      Emergency Contact *
                    </label>
                    <input
                      id="emergencyContact"
                  ...
                  {/* Medical Conditions */}
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-medium mb-1" htmlFor="medicalConditions">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-2">
                      {["Personal Care", "Medication Reminder", "Mobility Assistance", "Meal Preparation", "Housekeeping", "Transportation", "Companionship"].map((assist) => (
                        <div key={assist} className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor={`assist-${assist}`} className="ml-2 block text-sm text-gray-700">
                            {assist}
                          </label>
                        </div>
                      ))}
                    ...
                    {errors.assistanceNeeded && (
                      <p className="mt-1 text-sm text-red-500">{errors.assistanceNeeded}</p>
                    )}
                  </div>
                  
                  {/* Preferred Schedule */}
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-medium mb-1" htmlFor="preferredSchedule">
                      Preferred Schedule
                    </label>
                    <textarea
              ...
              <div className="flex justify-between mt-6">
                ...
                >
                  ...
                  ) : step < 2 ? "Next" : "Complete Registration"
                  }
                </button>
              </div>
            </form>
